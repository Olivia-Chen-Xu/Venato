        ...
        <div id="flex flex-col w-full gap-3">
            ...
            <Box className="w-full flex flex-col gap-20 mt-20">
                ...
                <Box className='flex justify-center w-full'>
                    <div className="blob-header flex flex-col text-white bg-purple p-10" style={{
                        //background: 'linear-gradient(90deg, #7F5BEB 0%, #926EFE 100%)'
                    }}>
                        <img src={whiteLogo} className="object-contain object-left h-[15vh] self-center"/>
                ...
                <Box className='flex justify-center w-full'>
                    ...
                    <span className='self-center mx-40 font-extrabold text-4xl'>Discover new jobs.</span>
                </Box>
                <Box className='flex justify-center w-full'>
                    <span className='self-center mx-40 font-extrabold text-4xl'>Prepare for your interviews.</span>
